...
public class StringManipulations01 {
    public static void main(String[] args) {
       ...
       int sLength= s.length();
        ...
        //Note: index herzaman 0 dan baslar bu nedenle s.charAt(0) herzaman ilk indexi verir.
        //Note2: index no olarak s.length()-1 gieresek bu bize dynamic olrarak her zaman son indexi verir
        ...
        // 2.yol
        // bir character den baslayip sonuna kadar alamk isterseniz tek parametreli kullanabirsiniz

        String sub4=s.substring(8);//easy
        System.out.println(sub4);

        // Example: "s" string nde easy kelimesinin var olup olmadigini kontrol ediniz.
       ...
       boolean isStart= s.startsWith("java");
        ...
        //Example: "s" string nin "easy" ile bitip bitmediyini kontrol ediniz
